...
static const char qt_meta_stringdata_FileHandler[] = {
    "FileHandler\0\0source\0sourceChanged(QString)\0"
    "msg\0error(QString)\0setSource(QString)\0"
    "QByteArray\0getFileData()\0QString\0"
};
...
void FileHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: { QByteArray _r = _t->getFileData();
...
const QMetaObjectExtraData FileHandler::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FileHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FileHandler,
      qt_meta_data_FileHandler, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FileHandler::getStaticMetaObject() { return staticMetaObject; }
...
// SIGNAL 0
void FileHandler::sourceChanged(const QString & _t1)
{
...
// SIGNAL 1
void FileHandler::error(const QString & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
